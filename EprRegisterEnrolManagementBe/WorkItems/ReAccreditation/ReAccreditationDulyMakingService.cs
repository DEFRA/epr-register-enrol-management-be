    ...
    )
    {
        workItem.AuditLog.Add(
            new WorkItemAuditEntry
            {
                ...
                // epr-rr9s: snapshot the state as of this event. Callers
                // invoke this AFTER any state mutation, so workItem.StateId
                // is the resulting post-mutation state for this entry.
